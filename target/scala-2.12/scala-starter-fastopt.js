...
/** @constructor */
function $c_sjs_Hello_Hello$() {
  $c_O.call(this)
}
$c_sjs_Hello_Hello$.prototype = new $h_O();
$c_sjs_Hello_Hello$.prototype.constructor = $c_sjs_Hello_Hello$;
/** @constructor */
function $h_sjs_Hello_Hello$() {
  /*<skip>*/
}
$h_sjs_Hello_Hello$.prototype = $c_sjs_Hello_Hello$.prototype;
$c_sjs_Hello_Hello$.prototype.init___ = (function() {
  return this
});
$c_sjs_Hello_Hello$.prototype.appendHello__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var titleNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("h1");
...
$c_sjs_Hello_Hello$.prototype.main__V = (function() {
  this.appendHello__Lorg_scalajs_dom_raw_Node__T__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "Hello Scala.js")
});
$c_sjs_Hello_Hello$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_sjs_Hello_Hello$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_sjs_Hello_Hello$ = new $TypeData().initClass({
  sjs_Hello_Hello$: 0
}, false, "scala.scalajs.Hello.Hello$", {
  sjs_Hello_Hello$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_sjs_Hello_Hello$.prototype.$classData = $d_sjs_Hello_Hello$;
var $n_sjs_Hello_Hello$ = (void 0);
function $m_sjs_Hello_Hello$() {
  if ((!$n_sjs_Hello_Hello$)) {
    $n_sjs_Hello_Hello$ = new $c_sjs_Hello_Hello$().init___()
  };
  return $n_sjs_Hello_Hello$
}
...
$e.scala = ($e.scala || {});
$e.scala.scalajs = ($e.scala.scalajs || {});
$e.scala.scalajs.Hello = ($e.scala.scalajs.Hello || {});
$e.scala.scalajs.Hello.Hello = $m_sjs_Hello_Hello$;
$m_sjs_Hello_Hello$().main__V();
}).call(this);
//# sourceMappingURL=scala-starter-fastopt.js.map
